...
object WMMatching {
  def maxWeightMatching (edges: List[(Int, Int, Int)], maxcardinality: Boolean) : Array[Int] = {
    /*
    ...
    */
    ...
    def slack(k: Int) = {
      dualvar(edges_a(k)._1) + dualvar(edges_a(k)._2) - 2 * edges_a(k)._3
    }
